      ...
      <section className="space-y-6 pb-8 pt-6 md:pb-12 md:pt-10 lg:py-32">
        <div className="container flex max-w-[64rem] flex-col items-center gap-4 text-center">
          ...
          <p className="max-w-[42rem] font-display leading-normal text-muted-foreground sm:text-xl sm:leading-8">
            a simple website where you can track your github repositories which
            was made as part of a coding challenge to test my frontend {`(Next.js)`} skills.
          </p>
          <div className="space-x-4">
            ...
            <Link
              href="https://github.com/ajzal-byte/github-repo-tracker"
              target="_blank"
              rel="noreferrer"
              className={cn(
